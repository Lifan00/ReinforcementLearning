...
from miniDT.utils.tools import TrajectoryDataset, evaluate_on_env, get_rl_normalized_score
...
def train(args=None):
    ...
    info_name = "info_" + dataset_name + "_batch" + str(batch_size) + "_" + "context" + str(
        context_len) + "_epoch" + str(MAX_ITERS) + "_update" + str(UPDATES_PER_ITER) + "_HEADx" + str(N_HEADS)
...
if __name__ == '__main__':
    ...
    train(conf)
    # python dp_train.py --device_ids=0,1
