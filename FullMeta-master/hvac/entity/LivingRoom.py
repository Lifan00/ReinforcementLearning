...
from hvac.tools.config import ROOM_H, INIT_TEMPERATURE_IN, DEFAULT_VEL, \
    DEFAULT_RH, DEFAULT_MET, DEFAULT_PA, INIT_TIMESTAMP, AIR_DENSITY, AIR_SHC, LR_L, LR_W, TIME_GAP, \
...
class LivingRoom(Room):
    def __init__(self, id,seed=0,work_time=24):
        super().__init__(id,seed=0,work_time=24)
        self.id = id
        self.L = LR_L
        self.W = LR_W
        self.H = ROOM_H
        ...
        # 默认客厅是老人，每天任何时候都在家
        self.people = People(id,seed,work_time)
