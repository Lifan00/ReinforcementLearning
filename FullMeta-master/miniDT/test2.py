...
from hvac.tools.config import PMV_LIMIT
from miniDT.utils.config import *
from miniDT.utils.model import DecisionTransformer
from miniDT.utils.test import count_target, evaluate_on_env
from miniDT.utils.tools import TrajectoryDataset
...
def train():
    ...
    dataset_path = f'./miniDT/data/{dataset_name}.pkl'
    ...
    rtg_target, _ = count_target(dataset_path)
    ...
    for i_train_iter in range(max_train_iters):
        ...
        avg_reward, avg_pmv_people_exist = evaluate_on_env(model, device, context_len, rtg_target)
        results = avg_reward * (PMV_LIMIT - avg_pmv_people_exist) / PMV_LIMIT
        # **********************************************************************
